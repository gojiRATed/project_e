<nav
  class="bg-blue-800 border-b border-blue-800 px-4 py-2.5 dark:bg-slate-950 dark:border-slate-800 fixed left-0 right-0 top-0 z-50">
  <div class="flex flex-wrap justify-between items-center">
    <div class="flex justify-start items-center">
      <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
        <img src="https://flowbite.s3.amazonaws.com/logo.svg" class="mr-3 h-8" alt="Flowbite Logo" />
        <span
          class="self-center text-2xl font-semibold whitespace-nowrap text-slate-100 dark:text-slate-50">Flowbite</span>
      </a>
      <form action="#" method="GET" class="hidden lg:block md:pl-2">
        <label for="topbar-search" class="sr-only">Search</label>
        <div class="relative md:w-64 ">
          <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
            <svg class="w-5 h-5 text-slate-400 dark:text-slate-500" fill="currentColor" viewBox="0 0 20 20"
          ...
          <input type="text" name="email" id="topbar-search"
            class="bg-slate-100 border border-slate-200 text-slate-900 text-sm rounded-lg focus:ring-primary-500 focus:border-slate-500 block w-full pl-10 p-2.5 dark:bg-slate-800 dark:border-slate-700 dark:placeholder-slate-500 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
            placeholder="Search" />
        </div>
      </form>
    </div>
    <div class="flex items-center gap-2">
      <button id="toggle-theme"
        class="hidden md:flex rounded-full items-center hover:scale-105 transition bg-slate-300 dark:bg-slate-900 p-1 mx-2">
        <p id="theme-name"
          class="ml-1 font-semibold p-1 text-xs text-slate-700 hover:text-slate-600 dark:text-slate-300 dark:hover:text-slate-50">
          Siang</p>
        <img id="theme-icon" src="https://img.icons8.com/emoji/48/sun-emoji.png" alt="Sun"
          class="size-7 object-contain ">
      </button>
      <button type="button"
        class="hidden md:flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
      ...
      <!-- Dropdown menu -->
      <div
        class="hidden z-50 my-4 w-56 text-sm list-none bg-white divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
        id="dropdown">
        <div class="py-3 px-4">
          <span class="block text-sm font-semibold text-gray-900 dark:text-white">Neil Sims</span>
          <span class="block text-sm text-gray-900 truncate dark:text-white">name@flowbite.com</span>
          <span class="block text-xs text-gray-700 truncate dark:text-gray-300 mt-2">Rp. 100.000</span>
        </div>
...
<aside
  ...
  <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
    <div class="max-md:flex hidden items-center justify-between pt-2 pb-5 px-2">
      <button id="toggle-themesm"
        class="rounded-full flex items-center hover:scale-105 transition bg-slate-300 dark:bg-slate-900 p-1 mx-2">
        <p id="theme-namesm"
          class="ml-1 font-semibold p-1 text-xs text-slate-700 hover:text-slate-600 dark:text-slate-300 dark:hover:text-slate-50">
          Siang</p>
        <img id="theme-iconsm" src="https://img.icons8.com/emoji/48/sun-emoji.png" alt="Sun"
          class="size-7 object-contain ">
      </button>
      <button type="button"
        class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
        id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdownsm">
        <span class="sr-only">Open user menu</span>
        <img class="w-8 h-8 rounded-full"
          src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gough.png" alt="user photo" />
      </button>
      ...
      <div
        ...
        <div class="py-3 px-4">
          <span class="block text-sm font-semibold text-gray-900 dark:text-white">Neil Sims</span>
          <span class="block text-sm text-gray-900 truncate dark:text-white">name@flowbite.com</span>
          <span class="block text-sm text-gray-900 truncate dark:text-white">Rp. 100.000</span>
        </div>
        <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdownsm">
          <li>
            <a href="#"
              class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">My
              profile</a>
    ...
    <form action="#" method="GET" class="lg:hidden mb-4">
      ...
      <div class="relative">
        ...
        <input type="text" name="search" id="sidebar-search"
          class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-lg focus:ring-slate-300 focus:border-slate-300 block w-full pl-10 p-2 dark:bg-slate-700 dark:border-slate-500 dark:placeholder-slate-400 dark:text-white dark:focus:ring-slate-500 dark:focus:border-slate-500"
          placeholder="Search" />
      </div>
    </form>
    <ul class="space-y-2">
      <li>
        <a href="#"
          class="flex items-center p-2 text-sm text-gray-600 rounded-lg dark:text-slate-200 hover:bg-gray-100 dark:hover:bg-gray-700 group">
          <svg aria-hidden="true"
            class="w-6 h-6 text-gray-600 transition duration-75 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white"
            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      <li>
        <button type="button"
          class="flex items-center p-2 w-full text-sm text-gray-600 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
          aria-controls="dropdown-kantin" data-collapse-toggle="dropdown-kantin">
          <svg aria-hidden="true"
            class="flex-shrink-0 w-6 h-6 text-gray-600 transition duration-75 group-hover:text-gray-900 dark:text-gray-200 dark:group-hover:text-white"
            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
          ...
          <span class="flex-1 ml-3 text-left whitespace-nowrap capitalize">Kantin Pintar</span>
          <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
              d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
      ...
      <li>
        <button type="button"
          class="flex items-center p-2 w-full text-sm text-gray-600 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
          aria-controls="dropdown-sekolah" data-collapse-toggle="dropdown-sekolah">
          <svg aria-hidden="true"
            class="flex-shrink-0 w-6 h-6 text-gray-600 transition duration-75 group-hover:text-gray-900 dark:text-gray-200 dark:group-hover:text-white"
            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
          ...
          <span class="flex-1 ml-3 text-left whitespace-nowrap capitalize">Informasi Sekolah</span>
          <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
              d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
      ...
      <li>
        <button type="button"
          ...
          <span class="flex-1 ml-3 text-left whitespace-nowrap capitalize">Pengguna ED</span>
          <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
              d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
      ...
      <li>
        <a href="#"
          class="flex items-center p-2 text-sm text-gray-600 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
          <svg aria-hidden="true"
            class="flex-shrink-0 w-6 h-6 text-gray-600 transition duration-75 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white"
            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
              d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-2 0c0 .993-.241 1.929-.668 2.754l-1.524-1.525a3.997 3.997 0 00.078-2.183l1.562-1.562C15.802 8.249 16 9.1 16 10zm-5.165 3.913l1.58 1.58A5.98 5.98 0 0110 16a5.976 5.976 0 01-2.516-.552l1.562-1.562a4.006 4.006 0 001.789.027zm-4.677-2.796a4.002 4.002 0 01-.041-2.08l-.08.08-1.53-1.533A5.98 5.98 0 004 10c0 .954.223 1.856.619 2.657l1.54-1.54zm1.088-6.45A5.974 5.974 0 0110 4c.954 0 1.856.223 2.657.619l-1.54 1.54a4.002 4.002 0 00-2.346.033L7.246 4.668zM12 10a2 2 0 11-4 0 2 2 0 014 0z"
              clip-rule="evenodd"></path>
          </svg>
          <span class="ml-3">Dompet Digital</span>
        </a>
      </li>
    </ul>
