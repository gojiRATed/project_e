<x-app-layout>
  ...
  <div class="border-2 rounded-lg border-gray-200 dark:border-gray-700 h-96 mb-4">
    <div class="w-full max-h-96 bg-slate-50 rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">
